...
public class Register {
	...
	public Register(Game obj) {
		Facade.start();
	
		try {
			Facade.registerGame(obj);
		} catch(Exception e) {
	...
	public Register(User obj) {
		Facade.start();
		
		try {
			Facade.registerUser(obj);
		} catch(Exception e) {
			System.out.println(e.getMessage());
		}			
	...
	public static void main(String[] args) {
		...
		// Adding users
		new Register(new User("Adelso","adelso@gmail.com", "123456"));
		new Register(new User("Juniores", "juniores@hotmail.com", "abcd"));
	}
}
